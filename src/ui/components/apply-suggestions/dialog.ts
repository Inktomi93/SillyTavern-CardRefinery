// src/ui/components/apply-suggestions/dialog.ts
// =============================================================================
// APPLY DIALOG
// =============================================================================

import { toast, log, CHARACTER_FIELDS } from '../../../shared';
import { getState } from '../../../state';
import { getPopulatedFields } from '../../../domain/character/fields';
import {
    formatFieldForEditing,
    isEditableFieldType,
    loadApplyDialogTokens,
} from './helpers';
import {
    applyFieldsToCharacter,
    savePngWithFields,
    saveJsonWithFields,
} from './apply';
